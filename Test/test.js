...
var typeDefs = (0, apollo_server_express_1.gql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  type Query {\n    step(input: JSON): String\n  }\n"], ["\n  type Query {\n    step(input: JSON): String\n  }\n"])));
var resolvers = {
    Query: {
        step: function (_, _a) {
            var input = _a.input;
            return __awaiter(void 0, void 0, void 0, function () {
                var stepFunctions, stepFunctionInput, executionArn, status_1, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            stepFunctions = new aws_sdk_1["default"].StepFunctions();
                            stepFunctionInput = JSON.stringify(input);
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 4, , 5]);
                            return [4 /*yield*/, stepFunctions
                                    .startExecution({
                                    stateMachineArn: 'arn:aws:states:us-east-1:016293920362:execution:HelloWorld:1cc90f73-db49-5632-8672-142c3959f89a',
                                    input: stepFunctionInput
                                })
                                    .promise()];
                        case 2:
                            executionArn = (_b.sent()).executionArn;
                            return [4 /*yield*/, stepFunctions
                                    .describeExecution({
